...
public class WebMotionLanguageHierarchy extends LanguageHierarchy<WebMotionTokenId> {
    ...
    private static void init() {
        tokens = Arrays.<WebMotionTokenId>asList(new WebMotionTokenId[]{
            ...
            new WebMotionTokenId("SECTION_CONFIG_NAME", "section", 8, NONE),
            new WebMotionTokenId("SECTION_ACTIONS_NAME", "section", 9, NONE),
            new WebMotionTokenId("SECTION_ERRORS_NAME", "section", 10, NONE),
            new WebMotionTokenId("SECTION_FILTERS_NAME", "section", 11, NONE),
            new WebMotionTokenId("SECTION_EXTENSIONS_NAME", "section", 12, NONE),
            new WebMotionTokenId("SECTION_PROPERTIES_NAME", "section", 13, NONE),
